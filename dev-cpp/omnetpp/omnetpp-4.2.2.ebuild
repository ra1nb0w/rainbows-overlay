...
pkg_postinst() {
    ...
    elog ""
	# in my case
	# * Please put following into your .bashrc
	# *     export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/opt/omnetpp-4.2.2/lib
	# *     export PATH=$PATH:/opt/omnetpp-4.2.2/bin
